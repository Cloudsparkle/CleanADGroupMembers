...
.DESCRIPTION
  This script provides a GUI to quickly clean an existing AD group from disabled user accounts
...
#$members = Get-ADGroupMember -Recursive -Identity $ADGroup.Name -Server $dc.HostName[0] 
}
Else
{
